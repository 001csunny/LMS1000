...
async function createMockupData() {
  ...
  // Create Lessons for Course 1 (Basic English)
  ...
  // Create Lessons for Course 2 (Thai)
  ...
  // Create Vocabularies for Lesson 1 (English Greetings)
  ...
  // Create Vocabularies for Lesson 4 (Thai Greetings)
  ...
  // Create Exercises for Lesson 1 (English)
  ...
  // Create Exercises for Lesson 4 (Thai)
  await prisma.exercise.createMany({
    data: [
      {
        lessonId: lesson4.id,
  ...
  // Create some speech results (using correct exercise IDs)
  const exercises = await prisma.exercise.findMany({
    where: { type: ExerciseType.SPEAKING },
    take: 3,
  });
