...
const public_lessons_controller_1 = require("./public-lessons.controller");
...
exports.LessonsModule = LessonsModule = __decorate([
    (0, common_1.Module)({
        ...
        controllers: [lessons_controller_1.LessonsController, public_lessons_controller_1.PublicLessonsController],
    })
], LessonsModule);
