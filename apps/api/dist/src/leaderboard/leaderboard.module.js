...
const leaderboard_gateway_1 = require("./leaderboard.gateway");
...
exports.LeaderboardModule = LeaderboardModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [leaderboard_gateway_1.LeaderboardGateway],
        exports: [leaderboard_gateway_1.LeaderboardGateway],
    })
], LeaderboardModule);
